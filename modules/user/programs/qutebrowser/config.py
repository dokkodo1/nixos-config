...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/dokkodo/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/dokkodo/.local/share/qutebrowser/userscripts/*')
...
#   - false
#   - ask
config.set('content.notifications.enabled', False, 'https://eu.fahufaom.click')
