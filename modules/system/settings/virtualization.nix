...
with lib;
let
  cfg = config.dox.virtualization;
in {
  options.dox.virtualization = {
      ...
      assertions = [
        {
          ...
          message = "You must specify GPU PCI IDs for passthrough in dox.virtualization.gpuPassthrough.gpuIDs";
        }
      ];
      ...
      assertions = [
        {
          ...
          message = "You must specify a user for Looking Glass in dox.virtualization.lookingGlass.user";
        }
      ];
